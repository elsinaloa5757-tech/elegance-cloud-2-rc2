...
class PersistentSQLiteLease:
    ...
    def __enter__(self) -> LeaseStatus:
        ...
        try:
            ...
            # Never let one slow request consume the full serverless execution
            # window while it waits behind another database snapshot.
            ...
            # required or a failed serverless request leaks its Postgres session.
